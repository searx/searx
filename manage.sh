...
pep8_check() {
    ...
    flake8 --ignore "E117 E211 E231 E302 E305 E402 E501 E722 F401 F632 F811 F821 F841 W291 W391 W605" --exclude "$SEARX_DIR/static/themes" "$SEARX_DIR" "$BASE_DIR/tests" "$BASE_DIR/utils" "setup.py"
}
