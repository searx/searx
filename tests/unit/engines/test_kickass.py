...
class TestKickassEngine(SearxTestCase):
    ...
    def test_response(self):
        ...
        self.assertEqual(results[1]['filesize'], 1024 * 1024)
        self.assertEqual(results[2]['filesize'], 1024 * 1024 * 1024)
        self.assertEqual(results[3]['filesize'], 1024 * 1024 * 1024 * 1024)
